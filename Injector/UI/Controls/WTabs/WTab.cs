...
namespace Injector.UI.Controls.WTabs
{
    ...
    {
        private Injector.UI.Controls.WTabs.WTabBar wTabBar1;
        ...
        {
            this.wTabBar1 = new Injector.UI.Controls.WTabs.WTabBar();
        ...
        public Tab AddTab(Form tabPage, string tabText)
        {
            ...
            //	tabPage.Height = this.Height - 4  - wTabBar1.Height;
            //	tabPage.Width  = this.Width - 4;
