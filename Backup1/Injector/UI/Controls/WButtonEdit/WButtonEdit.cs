...
namespace Injector.UI.Controls
{
	...
	public class WButtonEdit : WFocusedCtrlBase
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_pTextBox = new Injector.UI.Controls.WTextBoxBase();
			...
			this.m_pTextBox.Mask = Injector.UI.Controls.WEditBox_Mask.Text;
		...
		/// 
		/// </summary>
		[Obsolete("Misspelled use AcceptsPlusKey instead")]
